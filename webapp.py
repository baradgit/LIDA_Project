...
import pandas as pd
from chat_bot import initialize_lida, store_csv_in_db, generate_sql_query, run_sql_query, generate_visualization, split_query_into_parts, is_visualization_query, is_table_query
...
if api_key:
    try:
        # Initialize OpenAI and LIDA client
        ...
        st.error("Wrong API Key. Please enter a valid OpenAI API Key.")
    except Exception as e:
